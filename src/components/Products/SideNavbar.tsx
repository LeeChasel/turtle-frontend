...
function SideNavbar() {
  ...
  function createQueryStringForLinks(
    paramsArray: CreateLinkFnParams[],
    nonPrice?: "nonPrice",
  ) {
  ...
  function createPriceClass(
    ...
    if (
      minPrice.toLocaleString() === queryMinPrice &&
      maxPrice.toLocaleString() === queryMaxPrice
    ) {
      if (!nonPrice) {
        return selectedQueryBtnColor;
      }
      ...
      <ul className="w-40 gap-2 bg-gray-300 menu rounded-box">
        <li>
          ...
          <ul>
            <li>
              <Link
                className={createPriceClass(0, 199, true)}
                to={createQueryStringForLinks(
                  [
                    { key: "minPrice", value: "0" },
                    { key: "maxPrice", value: "199" },
                  ],
                  "nonPrice",
                )}
              >
            ...
            <li>
              <Link
                className={createPriceClass(0, 199)}
                to={createQueryStringForLinks([
                  { key: "minPrice", value: "0" },
                  { key: "maxPrice", value: "199" },
                ])}
            ...
            <li>
              <Link
                className={createPriceClass(200, 499)}
                to={createQueryStringForLinks([
                  { key: "minPrice", value: "200" },
                  { key: "maxPrice", value: "499" },
                ])}
              >
                200至500元
              </Link>
            ...
            <li>
              <Link
                className={createPriceClass(500, 999)}
                to={createQueryStringForLinks([
                  { key: "minPrice", value: "500" },
                  { key: "maxPrice", value: "999" },
                ])}
              >
                500至1000元
              </Link>
        ...
        <li>
          ...
          <ul>
            <li>
              <Link
                className={createSuaClass("true")}
                to={createQueryStringForLinks([{ key: "sua", value: "true" }])}
              >
                所有商品
              </Link>
            </li>
            <li>
              <Link
                className={createSuaClass("false")}
                to={createQueryStringForLinks([{ key: "sua", value: "false" }])}
              >
                可購買
              </Link>
            </li>
        ...
        <li>
          ...
          <ul>
            <li>
              <Link
                className={createSortClass("desc")}
                to={createQueryStringForLinks([{ key: "sort", value: "" }])}
              >
                高到低
              </Link>
            </li>
            <li>
              <Link
                className={createSortClass("asc")}
                to={createQueryStringForLinks([{ key: "sort", value: "asc" }])}
              >
                低到高
              </Link>
            </li>
