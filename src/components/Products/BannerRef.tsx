...
const BannerRef = forwardRef<HTMLDivElement, ProductBannerRefProps>(({ product }, ref) => {
  const productItem = (
    <BannerCard productName={product.productName} bannerImage={product.bannerImage} currentPrice={product.currentPrice!}/>
  )
  const content = ref
